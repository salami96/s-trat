...
<html lang="pt-br">
  <head>
    ...
    <link rel="icon" href="../templates/ico.png">
  ...
  <body>
          ...
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="../prof/pacientes">
    ...
    $(document).ready(function() {
      ...
      var idProf = 1;
      $.getJSON("../consultas/"+idProf, function(result){
        for (row in result) {
          var itens = result[row];
          var aux = itens['paciente']+itens['consulta'];
          ...
          $('#paciente').append("<tr><td>"+itens['paciente']+"</td>"+
              "<td>"+format(itens['consulta'])+"</td></tr>");
        }
        feather.replace();
